...
|---------|------|---------------|-----------|---------|
| [Claude Code](https://claude.ai/code) | `--cc` | claude-sonnet-4-6 | Anthropic | `curl -fsSL https://claude.ai/install.sh \| bash` |
| [Codex CLI](https://developers.openai.com/codex/cli) | `--codex` | gpt-5.3-codex | OpenAI | `npm install -g @openai/codex` |
