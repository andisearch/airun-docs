...
|---------|------|---------------|-----------|---------|
| [Claude Code](https://claude.ai/code) | `--cc` | claude-opus-4-7 | Anthropic | `curl -fsSL https://claude.ai/install.sh \| bash` |
